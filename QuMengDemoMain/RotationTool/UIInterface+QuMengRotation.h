...
@interface UIViewController (QMRotation)
...
/**
 ...
 @note 请注意与 @c qumeng_setNeedsUpdateOfSupportedInterfaceOrientations 的区别：如果你的界面支持N个方向，而你希望保持对这N个方向的支持的情况下把设备方向旋转为这N个方向里的某一个时，应该调用 @c qumeng_rotateToInterfaceOrientation: 。如果你的界面支持N个方向，而某些情况下你希望把N换成M并触发设备的方向刷新，则请修改方向后，调用 @c qumeng_setNeedsUpdateOfSupportedInterfaceOrientations 。
 */
...
@interface UINavigationController (QMRotation)
@end


@interface UITabBarController (QMRotation)
@end
